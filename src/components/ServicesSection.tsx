...
const services = [
  {
    ...
    desc: "Διάγνωση και επιδιόρθωση βλαβών σε επίπεδο hardware και software. Αντικατάσταση οθόνης, μπαταρίας, πληκτρολογίου.",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    desc: "Μεγάλη γκάμα από αξιόπιστα, συμβατά laser toners για τους περισσότερους εκτυπωτές.",
  },
];
